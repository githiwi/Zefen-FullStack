  ...
  return (
    <div>
      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
        ...
        <div class="offcanvas-body">
          <div>This Web app is about the four scales of Ethiopian music. Which are Ambasel, Bati, Tizita, and Anchihoye.</div>
          <ul class="list-group list-group-flush mt-3">
            <li class="list-group-item">
              <Link className="nav-link text-center" to="/" onClick={handleLinkClick}>
                Home
              </Link>
            </li>
            <li class="list-group-item">
              <Link className="nav-link text-center" to="/categories" onClick={handleLinkClick}>
                Music Genres
              </Link>
            </li>
            <li class="list-group-item">
              <Link className="nav-link text-center" to="/searchArtist" onClick={handleLinkClick}>
                Search
              </Link>
            </li>
            <li class="list-group-item">
              <Link className="nav-link text-center" to="/instruments" onClick={handleLinkClick}>
                Instruments
              </Link>
            </li>
            <li class="list-group-item">
              <Link className="nav-link text-center" to="/addSong" onClick={handleLinkClick}>
                Add Song
              </Link>
            </li>
            <li class="list-group-item">
              <Link className="nav-link text-center" to="/about" onClick={handleLinkClick}>
                About
              </Link>
            </li>
            {user ? (
              <li className="list-group-item">
                <div className="d-flex align-items-center justify-content-center">
                  ...
                  <Link className="nav-link text-center" to="/" onClick={handleSignOut}>
                    Sign Out
                  </Link>
                </div>
              </li>
              ...
              <>
                <li className="list-group-item">
                  <Link className="nav-link text-center" to="/signin" onClick={handleLinkClick}>
                    Login
                  </Link>
                </li>
                <li className="list-group-item">
                  <Link className="nav-link text-center" to="/signup" onClick={handleLinkClick}>
                    Signup
                  </Link>
                </li>
              </>
